...
const milestones: Milestone[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        id: 'm1-admin',
        title: 'Admin basics',
        description: 'Створення/редагування компаній і користувачів, блокування.',
        min: 50,
        max: 75,
        category: 'Feature',
        priority: 'required',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        description: 'Маршрут, точки, вантаж, вимоги до ТЗ, контакти.',
        min: 70,
        max: 105,
        category: 'Feature',
        priority: 'required',
    ...
    blocks: [
      {
        ...
        description: 'Тип ТЗ, тоннаж, напрямок, географія, активність.',
        min: 60,
        max: 95,
        category: 'Architecture',
        priority: 'required',
      ...
      },
      {
        ...
        description: 'Базові web/push notifications.',
        min: 35,
        max: 60,
        category: 'Feature',
        priority: 'required',
      ...
      },
      {
        ...
        description: 'Прийняти/відмовитись, призначити авто/водія.',
        min: 50,
        max: 80,
        category: 'Feature',
        priority: 'required',
    ...
    blocks: [
      {
        ...
        description: 'Активні рейси, статуси, винятки, базовий GPS view.',
        min: 60,
        max: 95,
        category: 'Feature',
        priority: 'required',
      ...
      },
      {
        ...
        description: 'Список документів, missing/approved statuses.',
        min: 50,
        max: 80,
        category: 'Feature',
        priority: 'required',
    ...
    blocks: [
      {
        ...
        priority: 'recommended',
        consequence: 'Перші дані доведеться заводити вручну або через спрощений ad-hoc import.',
      },
      {
        id: 'm7-medoc',
      ...
      },
      {
        ...
        category: 'Integration',
        priority: 'recommended',
        consequence: 'Фінансові записи доведеться переносити в бухгалтерські системи вручну.',
      },
      {
        id: 'm7-hardening',
